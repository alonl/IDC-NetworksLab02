...
public class SMTPApp {
    ...
    public SMTPApp(Properties properties) throws IOException, SQLException {
        ...
        SMTPThreadPool smtpThreadPool = new SMTPThreadPool(SMTP_THREAD_POOL_SIZE, smtpName, smtpPort, smtpUsername, smtpPassword);
    ...
    private void setProperties(Properties appProperties) {
        ...
        this.serverName = appProperties.getProperty(MainRunner.SERVER_NAME_PROPERTY) + ":" + appProperties.getProperty(MainRunner.PORT_PROPERTY);
